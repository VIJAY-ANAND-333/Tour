...
import TelanganaPosts from './TelanganaPosts';
  ...
  return (
    <>
      ...
      <div className='banner3'>
        <p className='tourTitles' style={{ color: "black" }}>Tourism to Telangana</p>
      </div>
      <div>
      ...
      <div>
        ...
        {isVisible && <div>
          ...
          <Link to='/commentAndhra/ Temples'><img src={templeTalanglana} alt="" className='telimages' /></Link>
          ...
          <div className='TelcatogaryDiv'>
          <Link to='/commentAndhra/Museums'><img src={MuseumsTel} alt="" className='telimages' />
          </Link>
          ...
          <div className='TelcatogaryDiv'>
          <Link to='/commentAndhra/Lakes & Waterfalls'><img src={WaterfallsTelangana} alt="" className='telimages' /></Link>
          ...
          <div className='TelcatogaryDiv'>
          <Link to='/commentAndhra/Forts & Palaces'><img src={PalacesTelanagana} alt="" className='telimages' /></Link>
          ...
          <div className='TelcatogaryDiv'>
          <Link to='/commentAndhra/Other Attractions'><img src={ramuji} alt="" className='telimages' /></Link>
        ...
        {religious && <div>
          ...
          <div className='TelcatogaryDiv'>
            <Link path='/TelanganaPosts' element={<TelanganaPosts/>}><img src={temple01} alt="" className='telimages' /></Link>
            <p className='textWBCat'>
